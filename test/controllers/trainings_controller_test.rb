...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { datefrom: @training.datefrom, dateto: @training.dateto, hours: @training.hours, name: @training.name, provider: @training.provider, role: @training.role, status: @training.status, venue: @training.venue } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { datefrom: @training.datefrom, dateto: @training.dateto, hours: @training.hours, name: @training.name, provider: @training.provider, role: @training.role, status: @training.status, venue: @training.venue } }
