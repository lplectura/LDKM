...
class TrainingsTest < ApplicationSystemTestCase
  ...
  test "creating a Training" do
    ...
    fill_in "Datefrom", with: @training.datefrom
    fill_in "Dateto", with: @training.dateto
    fill_in "Hours", with: @training.hours
    fill_in "Name", with: @training.name
    fill_in "Provider", with: @training.provider
    fill_in "Role", with: @training.role
    fill_in "Status", with: @training.status
    fill_in "Venue", with: @training.venue
